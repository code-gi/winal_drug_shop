...
class AnimalMedicationsScreen extends StatefulWidget {
  const AnimalMedicationsScreen({Key? key}) : super(key: key);

  @override
  State<AnimalMedicationsScreen> createState() =>
      _AnimalMedicationsScreenState();
}

class _AnimalMedicationsScreenState extends State<AnimalMedicationsScreen> {
  ...
  void initState() {
    ...
    // Load animal medications and categories on init
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final medicationProvider =
          Provider.of<MedicationProvider>(context, listen: false);
      medicationProvider.loadMedications(medicationType: 'animal');
      medicationProvider.loadCategories(medicationType: 'animal');
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Animal Medications'),
        actions: [
          IconButton(
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search animal medications...',
                ...
                suffixIcon: IconButton(
                  ...
                  onPressed: () {
                    ...
                    Provider.of<MedicationProvider>(context, listen: false)
                        .loadMedications(
                            searchQuery: '', medicationType: 'animal');
                  },
                ),
              ...
              onSubmitted: (value) {
                Provider.of<MedicationProvider>(context, listen: false)
                    .loadMedications(
                        searchQuery: value, medicationType: 'animal');
              },
            ),
          ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            provider.clearError();
                            provider.loadMedications(medicationType: 'animal');
                          },
